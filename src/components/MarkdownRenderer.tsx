        ...
        <div className="min-h-screen flex items-start justify-center bg-gray-50 pt-32 pb-24 px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-full max-w-full sm:max-w-2xl">
                <ReactMarkdown
                    ...
                    components={{
                        h1: ({ node, ...props }) => (
                            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-black mt-6 mb-4" {...props} />
                        ),
                        h2: ({ node, ...props }) => (
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-black mt-6 mb-4" {...props} />
                        ),
                        h3: ({ node, ...props }) => (

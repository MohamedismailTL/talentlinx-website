    ...
    return (
        <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div className="mx-auto max-w-4xl">
                <h2
                    className={classNames(
                        ...
                        'mt-2 text-balance text-3xl sm:text-5xl font-semibold tracking-tight text-brand-dark-500',
            ...
            >
                ...
                <div
                    className={classNames(
                        'bg-brand-gray-100 text-brand-dark-500 ring-1 ring-brand-gray-300',
                ...
                >
                    ...
                    <h3 className="mt-4 text-2xl sm:text-3xl font-semibold tracking-tight text-brand-dark-500">
                        {boxOne.box_title}
                    </h3>
                    <ul className="mt-8 space-y-6 text-sm sm:mt-10 text-brand-dark-400">
                  ...
                  <XMarkIcon aria-hidden="true" className="h-5 w-5 text-white" />
                                ...
                                {/* Heading + Subtitle */}
                                <div>
                                    <h4 className="text-base font-semibold text-brand-dark-500">{bullet_title}</h4>
                ...
                <div
                    className={classNames(
                        'relative bg-gradient-to-br from-brand-primary-600 to-brand-primary-700 text-white shadow-2xl',
                        'rounded-3xl p-8 sm:p-10 transform transition-opacity transition-transform duration-700'
                    )}
                ...
                >
                    ...
                    <ul className="mt-8 space-y-6 text-sm sm:mt-10 text-brand-primary-50">
                        {boxTwo.bulletpoints.map(({ bullet_title, bullet_text }: any) => (
                            <li key={bullet_title} className="flex gap-x-3">
                                {/* Icon */}
                                <span className="flex-none flex h-6 w-6 items-center justify-center rounded-full bg-brand-teal-500">
                  <CheckIcon aria-hidden="true" className="h-5 w-5 text-white" />
                </span>
                                {/* Heading + Subtitle */}
                                <div>
                                    <h4 className="text-base font-semibold text-white">{bullet_title}</h4>
                                    <p className="text-sm mt-1">{bullet_text}</p>
                                </div>
                            </li>
                        ))}
